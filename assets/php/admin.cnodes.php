...
$curl = new Curl('contributeNode', 'getSome', $params);
$curl->ready();
                ...
                <ul class="col-lg-6 col-sm-12 pagination justify-content-end">
                    <li class="page-item">
                        <a class="page-link" tabindex=""
                           href="<?= "admin.cnodes.php?p=" . ($page - 1); ?>">
                            Previous
                        </a>
                    </li>
                    <?php
...
function showRows($i, $row)
{
    ...
    echo "<td class='col-md-3'>" . $node . "</td>";
    echo "<td class='col-md-3'>" . $user . "</td>";
    echo "<td class='col-md-2'>" . ($errorLng + $errorLat)/2 . "</td>";

    echo "<td class='col-md-3'>";
    echo "<form action='cnode.view.php?id={$id}' method='POST'>";
